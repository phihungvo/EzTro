...
public class ElectricWaterRecordSpecs {
    ...
    public static Specification<ElectricWaterRecord> ownedByOwner(User owner) {
    ...
    public static Specification<ElectricWaterRecord> inMonthYear(Integer month, Integer year) {
        return (root, query, cb) -> {
    ...
    public static Specification<ElectricWaterRecord> hasRoom(Integer roomId) {
